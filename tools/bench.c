...
static const char *DEFAULT_JSON =
    "{"
    "\"users\":["
    "{\"id\":1,\"name\":\"Alice\",\"score\":98.5,\"active\":true,\"tags\":["
    "\"admin\",\"user\"]},"
    "{\"id\":2,\"name\":\"Bob\",  "
    "\"score\":72.1,\"active\":false,\"tags\":[\"user\"]},"
    "{\"id\":3,\"name\":\"Carol\",\"score\":88.0,\"active\":true,\"tags\":["
    "\"mod\",\"user\"]}"
    "],"
...
int main(int argc, char **argv)
{
    ...
    double str_mbs =
        ((double)(sample ? strlen(sample) : 0) / (1024.0 * 1024.0)) / str_mean;
    free(sample);
    json_free(root);
